...
const translations = {
  en: {
    app_title: 'Meal Buddy',
    home: 'Home',
    dashboard: 'Dashboard',
    sign_in: 'Sign In',
    sign_up: 'Sign Up',
    logout: 'Logout',
    vote_now: 'Dining status',
    ...
    weekly_menu_subtitle: 'Fresh meals prepared daily by our expert chef. Vote before 10am',
    how_it_works: 'How Meal Buddy Works',
    how_step1_title: 'Master Chef Plans Menu',
    how_step1_desc: 'Daily chef-curated meals are added to the weekly dashboard.',
    how_step2_title: 'Employee Vote',
    ...
    footer_rights: '© 2026 Meal Buddy. All rights reserved.',
    ...
    username_bo: 'Username (Tibetan)',
    nickname_en: 'Nickname (English)',
    nickname_bo: 'Nickname (Tibetan)',
    saving: 'Saving...',
    ...
    since_joined: 'Since you joined Meal Buddy',
    ...
    vote_no: 'No, skip for today',
    voting_locked: 'Voting is now locked',
    response_cutoff: 'Response required by 10:00 AM',
    ...
    no_bill_exists: 'No bill exists for this period.',
    ...
    tab_billing: 'Billing Records',
    tab_participation: 'Lunch Participation',
    daily_participation: 'Daily View',
    weekly_participation: 'Weekly View',
    monthly_participation: 'Monthly View',
    not_registered: 'Not Registered',
    select_date: 'Select Date',
    select_week: 'Select Week',
    select_month: 'Select Month',
    total_opted_in: 'Total Opted-In',
    total_opted_out: 'Total Opted-Out',
    total_eligible: 'Total Eligible Days',
    no_menu_set: 'No Menu Set',
    participation_report: 'Participation Report',
    user_participation_status: 'User Participation Status',
    // Activity History Page Keys
    back_to_dashboard: 'Back to Dashboard',
    activity_history: 'Activity History',
    activity_history_subtitle: 'A complete record of your meal participations',
    loading_history: 'Loading history...',
    history_joined_lunch: 'Joined Lunch',
    history_skipped_lunch: 'Skipped Lunch',
    unknown_menu: 'Unknown Menu',
    no_history_found: 'No History Found',
    no_history_desc: "You haven't participated in any meals yet.",
    filter_all_time: 'All Time',
    filter_by_month: 'Filter by Month',
    clear_filter: 'Clear Filter',
    column_role: 'Role',
    column_department: 'Department',
    column_voted_at: 'Voted At',
    ...
    push_reminders_title: '9:00 AM Lunch Reminders',
    push_reminders_desc: "Get reminded every morning at 9:00 AM to vote if you're not joining lunch before the 10:00 AM cutoff.",
    push_enable_button: 'Enable Reminders',
    push_disable_button: 'Disable Reminders',
    push_test_button: 'Send Test Reminder',
    push_subscribed: 'Subscribed to 9:00 AM reminders',
    push_not_subscribed: 'Reminders disabled',
    push_permission_denied: 'Notifications are blocked in browser settings',
    push_enabled_success: '9:00 AM Lunch Reminders enabled successfully!',
    push_disabled_success: 'Lunch reminders disabled.',
    push_test_success: 'Test reminder notification sent! Check your screen.',
    push_unsupported: 'Push notifications are not supported by this browser.',
    push_reminder_notification_title: '🍽️ MealBuddy — Lunch Reminder',
    push_reminder_notification_body: "You’re in for lunch today! If you’re not joining, tap here to let us know before 10:00 AM.",
  },
  bo: {
    app_title: 'ཟས་མཐུན་ལས་རོགས།',
    home: 'གཙོ་ངོས།',
    dashboard: 'ལས་དོན་གཙོ་ལེབ།',
    sign_in: 'ནང་དུ་འཛུལ་བ།',
    sign_up: 'ཐོ་འགོད་བྱེད་པ།',
    logout: 'ཕྱིར་ཐོན་པ།',
    vote_now: 'ཉིན་ཟས་རྣམ་གཞག',
    join_team: 'རུ་ཁག་ལ་མཉམ་ཞུགས།',
    hero_title: 'ལས་ཁུངས་ཀྱི་ཉིན་ཟས།',
    hero_subtitle: 'ཚོགས་མི་རྣམས་ཀྱི་ཟས་ལ་འོས་བསྡུས་བྱེད་ཏེ་ཟས་ཟད་མི་འགྲོ་བར་བྱེད་པའི་ཐབས་ལམ།',
    weekly_menu_title: 'བདུན་ཕྲག་འདིའི་ཟས་མཐོ།',
    weekly_menu_subtitle: 'ཉིན་རེ་མ་བྱན་ལགས་ཀྱི་ཁ་ལག་སོས་པ་བཟོས་པར་ཆུ་ཚོད་ ༡༠ སྔོན་ནས་བཟའ་མིན་འོས་བྱེད་རོགས།',
    how_it_works: 'ཟས་མཐུན་ལས་རོགས་བྱེད་ཚུལ།',
    how_step1_title: 'མ་བྱན་ལགས་ཀྱི་ཟས་ཐོ་འཆར་གཞི།',
    how_step1_desc: 'ཉིན་རེའི་ཟས་མཆོག་རྣམས་བདུན་རེའི་ཟས་ཐོའི་ནང་དུ་བཀོད་སྒྲིག་བྱེད།',
    how_step2_title: 'ལས་བྱེད་རྣམས་ཀྱི་འོས།',
    how_step2_desc: 'རུ་ཁག་གི་ཚོགས་མི་ཚོས་ཞོགས་པ་ཆུ་ཚོད་ ༡༠ སྔོན་ལ་ཉིན་ཟས་བཞེས་མིན་ཐག་གཅོད་བྱེད།',
    how_step3_title: 'བཟོས་དགོས་པ།',
    how_step3_desc: 'མ་བྱན་ལགས་ཀྱི་དགོས་མཁོ་གང་ཡིན་པ་བཟོས་པར་ཟས་ཆུད་ཟོས་མ་འགྲོ་བའི་ཆེད།',
    ...
    user_dashboard_desc: 'ཁྱེད་ཀྱིས་ཉིན་ཟས་བརྩི་ཞིབ་དང་ཟས་ཐོ་གང་ཡིན་ལྟ་རོགས།',
    profile_settings: 'སྒེར་གྱི་ཆ་འཕྲིན།',
    profile_photo: 'སྒེར་གྱི་པར།',
    click_to_upload_photo: 'པར་འཇུག་ཕྱིར་འདིར་གནོན།',
    username_en: 'མིང། (དབྱིན་ཡིག)',
    username_bo: 'མིང། (བོད་ཡིག)',
    nickname_en: 'མིང་གཞན། (དབྱིན་ཡིག)',
    nickname_bo: 'མིང་གཞན། (བོད་ཡིག)',
    saving: 'ཉར་ཚགས་བྱེད་བཞིན་པ།...',
    profile_updated: 'སྒེར་གྱི་སྒྲིག་བཀོད་ལམ་ལྷོང་ངང་གསར་བཟོ་བྱས་ཟིན།',
    dashboard_summary: 'ལས་དོན་གཙོ་ལེབ་ཕྱོགས་བསྡོམས།',
    view_monthly_lunch_billing: 'ཟླ་རེའི་ཉིན་ཟས་རྩིས་ཐོ།',
    ...
    total_meals_eaten: 'ཞལ་ལག་བཞེས་པའི་གྲངས།',
    since_joined: 'ཁྱེད་རང་མཉམ་ཞུགས་བྱས་པ་ནས་བཟུང་།',
    current_month: 'ཟླ་འདི་ནང་།',
    days_tracked: 'ལས་ཀའི་ཉིན་གྲངས་ས་མཐའ།',
    ...
    // Vote Page
    will_you_join: 'ཁྱེད་རང་མཉམ་ཞུགས་གནང་གི་ཡིན་ནམ།',
    vote_yes: 'ང་ཡོང་གི་ཡིན།',
    vote_no: 'ང་དེ་རིང་ཡོང་གི་མིན།',
    voting_locked: 'འདེམས་ཤོག་འཕེན་མཚམས་བཅད་ཟིན།',
    response_cutoff: 'ཞོགས་པ་ཆུ་ཚོད་ ༡༠ སྔོན་ལ་ཐག་གཅོད་གནང་དགོས།',
    ...
    plan_your_meals: 'ཁྱེད་ཀྱི་ཉིན་ཟས་འཆར་གཞི།',
    ...
    chef_broadcast_info: 'ཆུ་ཚོད་ {time} • མ་བྱན་ {name}',
    ...
    // Chef Dashboard
    chef_greeting: 'སྔ་དྲོ་བདེ་ལེགས། མ་བྱན་ལགས།',
    ...
    // Billing Panels
    back_to_dashboard: 'གཙོ་སྟོན་མོལ།',
    ...
    general: 'སྤྱིར་བཏང་།',
    hr: 'མི་ཐབས་ཐོན་ཁུངས།',
    engineering: 'བཟོ་སྐྲུན་སྡེ་ཚན།',
    finance: 'རྩིས་རིག་སྡེ་ཚན།',
    sales: 'འཚོང་ཡིག་སྡེ་ཚན།',
    ...
    chef_upload_info: 'མ་བྱན་གྱིས་ཟླ་རེའི་རྩིས་ཐོ་གྲ་སྒྲིག་ཟིན་སྐབས་འདི་རུ་འཇུག་ངེས།',
    ...
    no_bill_exists: 'དུས་ཡུན་འདིར་རྩིས་ཐོ་མི་འདུག།',
    total_bill_amount: 'རྩིས་ཐོ་ཁྱོན་བསྡོམས། (སྒོར་ ₹)',
    ...
    'Red Bean Rice Curd': 'རྒྱ་སྲན་དམར་པོ་དང་འབྲས་ཞོ།',
    'Aloo Phinksha Tingmo': 'ཞོག་ཁོག་ཕིང་ཤ་དང་ཀྲིང་མོ།',
    ...
    chefs_special: 'དེ་རིང་གི་མ་བྱན་གསོལ་ཚིགས་དམིགས་བསལ།',
    menu_not_set: 'ཟས་ཐོ་བཀོད་མེད།',
    chef_not_decided: 'མ་བྱན་གྱིས་ཐག་གཅོད་བྱས་མེད།',
    tab_billing: 'རྩིས་ཐོ་ཉར་ཚགས།',
    tab_participation: 'ཉིན་ཟས་མཉམ་ཞུགས།',
    daily_participation: 'ཉིན་རེའི་ལྟ་ཞིབ།',
    weekly_participation: 'བདུན་རེའི་ལྟ་ཞིབ།',
    monthly_participation: 'ཟླ་རེའི་ལྟ་ཞིབ།',
    not_registered: 'ཐོ་འགོད་བྱས་མེད།',
    select_date: 'ཚེས་གྲངས་འདེམས་པ།',
    select_week: 'བདུན་ཕྲག་འདེམས་པ།',
    select_month: 'ཟླ་བ་འདེམས་པ།',
    total_opted_in: 'མཉམ་ཞུགས་བྱས་ཚད།',
    total_opted_out: 'མི་བཞེས་ཚད།',
    total_eligible: 'ཉིན་གྲངས་ཁྱོན་བསྡོམས།',
    no_menu_set: 'ཟས་ཐོ་བཀོད་མེད།',
    participation_report: 'མཉམ་ཞུགས་སྙན་ཐོ།',
    user_participation_status: 'མཉམ་ཞུགས་གནང་སྟངས།',
    // Activity History Page Keys
    activity_history: 'བྱ་བའི་ལོ་རྒྱུས།',
    activity_history_subtitle: 'ཁྱེད་ཀྱི་ཉིན་ཟས་ཞུགས་ཐོའི་ཟིན་ཐོ་ཆ་ཚང་།',
    loading_history: 'ལོ་རྒྱུས་འཇུག་བཞིན་པ།...',
    history_joined_lunch: 'ཉིན་ཟས་བཞེས་པ།',
    history_skipped_lunch: 'ཉིན་ཟས་མ་བཞེས་པ།',
    unknown_menu: 'ཟས་ཐོ་མི་གསལ།',
    no_history_found: 'ལོ་རྒྱུས་མ་རྙེད།',
    no_history_desc: 'ཁྱེད་ཀྱིས་ད་བར་ཉིན་ཟས་གང་ལའང་ཞུགས་མི་འདུག།',
    filter_all_time: 'དུས་ཚོད་ཆ་ཚང་།',
    filter_by_month: 'ཟླ་བ་ལྟར་འདེམས་པ།',
    clear_filter: 'འདེམས་ཚན་གསལ་བ།',
    column_role: 'ལས་གནས།',
    column_department: 'སྡེ་ཚན།',
    column_voted_at: 'འོས་འཕངས་དུས།',
    ...
    push_notifications: 'བརྡ་ཐོ་སྒྲིག་བཀོད།',
    push_reminders_title: 'ཞོགས་པ་ཆུ་ཚོད་ ༩:༠༠ པའི་ཉིན་ཟས་དྲན་སྐུལ།',
    push_reminders_desc: 'ཉིན་ལྟར་ཞོགས་པ་ཆུ་ཚོད་ ༩:༠༠ པར་དྲན་སྐུལ་བརྡ་ཐོ་འབྱོར་ཏེ་ཆུ་ཚོད་ ༡༠ སྔོན་ལ་ཉིན་ཟས་བཞེས་མིན་ཐག་གཅོད་གནང་རོགས།',
    push_enable_button: 'དྲན་སྐུལ་སྒོ་འབྱེད།',
    push_disable_button: 'དྲན་སྐུལ་སྒོ་རྒྱག',
    push_test_button: 'ཚོད་ལྟའི་བརྡ་ཐོ་གཏོང་བ།',
    push_subscribed: 'ཞོགས་པ་ཆུ་ཚོད་ ༩:༠༠ པའི་དྲན་སྐུལ་སྒོ་ཕྱེས་ཟིན།',
    push_not_subscribed: 'དྲན་སྐུལ་སྒོ་བརྒྱབ་ཡོད།',
    push_permission_denied: 'དྲ་བཤེར་ཆས་ནང་བརྡ་ཐོ་བཀག་འགོག་བྱས་འདུག',
    push_enabled_success: 'ཉིན་ཟས་དྲན་སྐུལ་བརྡ་ཐོ་ལམ་ལྷོང་ངང་སྒོ་ཕྱེས་ཟིན།',
    push_disabled_success: 'ཉིན་ཟས་དྲན་སྐུལ་བརྡ་ཐོ་སྒོ་བརྒྱབ་ཟིན།',
    push_test_success: 'ཚོད་ལྟའི་དྲན་སྐུལ་བརྡ་ཐོ་བཏང་ཟིན། ཁྱེད་ཀྱི་མཐོང་ངོས་ལ་གཟིགས་རོགས།',
    push_unsupported: 'དྲ་བཤེར་ཆས་འདིའི་ནང་བརྡ་ཐོ་གཏོང་ཐབས་མི་འདུག',
    push_reminder_notification_title: '🍽️ ཟས་མཐུན་ལས་རོགས། - ཉིན་གུང་གི་དྲན་སྐུལ།',
    push_reminder_notification_body: 'ཁྱེད་རང་དེ་རིང་ཉིན་གུང་ལ་མཉམ་ཞུགས་བྱེད་ཀྱི་ཡོད་དམ། གལ་ཏེ་མཉམ་ཞུགས་བྱེད་ཀྱི་མེད་ན་ཆུ་ཚོད་ ༡༠:༠༠ སྔོན་ལ་འདིར་ཐེངས་ཤིག་བསྣུན་ནས་ང་ཚོར་ཤེས་སུ་འཇུག་རོགས།',
  }
};
