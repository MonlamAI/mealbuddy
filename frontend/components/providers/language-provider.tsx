...
const translations = {
  en: {
    ...
    weekly_menu_subtitle: 'Fresh meals prepared daily by our expert chefs. Vote before 10 AM to join!',
  ...
  bo: {
    ...
    weekly_menu_subtitle: 'ང་ཚོའི་ཆེད་ལས་མ་ཆེན་གྱིས་ཉིན་ལྟར་གྲ་སྒྲིག་བྱས་པའི་ཟས་གསར་པ། ཞོགས་པ་ཆུ་ཚོད་ ༡༠ སྔོན་ལ་འདེམས་དགོས།',
